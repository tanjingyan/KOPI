...
public partial class LightChangerModel : RealtimeModel {
    ...
    public delegate void PropertyChangedHandler<in T>(LightChangerModel model, T value);
    ...
    public LightChangerModel() : base(null) {
