...
public class AutomaticDoor : MonoBehaviour
{
    ...
    void Update()
    {
        if (playerIsHere)
        {
            ...
            if (movingDoor1.transform.position.x < maximumOpening)
            {
                movingDoor1.transform.Translate(movementSpeed * Time.deltaTime, 0f, 0f);
            }
        }
        else
        {
            ...
            if (movingDoor1.transform.position.x > maximumClosing)
            {
                movingDoor1.transform.Translate(-movementSpeed * Time.deltaTime, 0f, 0f);
            }
        }
